      ...
      <div className="philosophy">
        <div className="philosophy-content reveal">
          ...
          <p className="philosophy-body">
            Geneva Insurance Group was founded on a simple conviction: the insurance experience is broken. As an independent agency, we serve families and businesses nationwide with a different approach — one built on transparency, deep expertise, and an unwavering commitment to doing what's right for each client we serve.
          </p>
        </div>
